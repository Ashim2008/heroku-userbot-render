...
if sys.version_info < (3, 9, 0):
    ...
    try:
        ...
        try:
            ...
            # Skip dependency installation in Replit/Nix environment
            if not any([os.environ.get("REPLIT_DEPLOYMENT"), os.environ.get("REPL_ID"), "replit" in os.environ.get("USER", "").lower()]):
    ...
    # Skip dependency installation in Replit/Nix environment
    if prev_hash != get_file_hash("requirements.txt") and not any([os.environ.get("REPLIT_DEPLOYMENT"), os.environ.get("REPL_ID"), "replit" in os.environ.get("USER", "").lower()]):
