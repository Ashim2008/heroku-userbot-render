...
if sys.version_info < (3, 9, 0):
    ...
    try:
        ...
        try:
            ...
            if not os.environ.get("REPLIT_DEPLOYMENT") and "replit" not in os.environ.get("USER", "").lower():
    ...
    # Skip dependency installation in Replit/Nix environment
    if prev_hash != get_file_hash("requirements.txt") and not os.environ.get("REPLIT_DEPLOYMENT") and "replit" not in os.environ.get("USER", "").lower():
